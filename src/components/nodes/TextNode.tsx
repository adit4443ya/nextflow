  ...
  return (
    ...
    >
      <textarea
        ...
        rows={3}
        className="w-full bg-[#0f0f11] border border-[#2a2a2e] rounded-lg px-3 py-2 text-sm
          text-[#e4e4e7] placeholder-[#52525b] resize-none focus:outline-none
          focus:border-purple-500/50 transition-colors nodrag nowheel"
      />
      <div className="flex justify-end">
        <span className="text-[9px] text-[#3a3a3e]">{(nodeData.text || "").length} chars</span>
      </div>
    </NodeWrapper>
  );
}
